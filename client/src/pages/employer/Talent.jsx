...
export default function Talent() {
  ...
  return (
    <div className="space-y-6 motion-safe-fade-in">
      ...
      {/* AI Disclaimer */}
      <div className="flex items-start gap-3 p-4 rounded-card bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800">
        ...
        <p className="text-sm text-brand-primary dark:text-blue-300 font-medium">{AI_DISCLAIMER}</p>
      </div>
