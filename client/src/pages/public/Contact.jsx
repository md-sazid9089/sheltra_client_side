...
const CONTACT_CARDS = [
  {
    ...
    label: 'Email Us',
    value: 'hello@sheltra.org',
    sub: 'We reply within 24 hours.',
    href: 'mailto:hello@sheltra.org',
  },
  {
    icon: <FaMapMarkerAlt className="w-6 h-6 text-cyan-300" />,
    label: 'Headquarters',
    value: 'Geneva, Switzerland',
    sub: 'Field offices in Nairobi & Amman.',
    href: null,
  },
  {
    ...
    label: 'Twitter / X',
    value: '@sheltraorg',
    sub: 'Follow for impact updates.',
    href: 'https://twitter.com/sheltraorg',
  },
  {
    icon: <FaLinkedin className="w-6 h-6 text-cyan-300" />,
    label: 'LinkedIn',
    value: 'linkedin.com/company/sheltra',
    sub: 'Partnerships & press enquiries.',
